...
namespace UserAPI.Services
{
    public class EmailService
    {
        ...
        public void SendActivationEmail(string[] destiny, string about, int userId, string code)
        {
            Mensage mensage = new Mensage(destiny, about, userId, code);
            var emailMensage = CreateActvationEmailBody(mensage);
            Send(emailMensage);
        }
        ...
        private MimeMessage CreateActvationEmailBody(Mensage mensage)
        {
         ...
         private MimeMessage CreateResetPasswordEmailBody(Mensage mensage)
        {
            var emailMensage = new MimeMessage();
            emailMensage.From.Add(MailboxAddress.Parse(_configuration.GetValue<string>("EmailSettings:From")));
            emailMensage.To.AddRange(mensage.Destiny);
